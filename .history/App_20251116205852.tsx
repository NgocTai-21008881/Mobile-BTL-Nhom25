    ...
    useEffect(() => {
        ...
        const { data: authListener } = supabase.auth.onAuthStateChange(
            (event, session) => {
                ...
                // SIGNED_UP = user vừa signup (nhưng sẽ logout ngay sau)
                ...
                if (event === "SIGNED_IN") {
                    ...
                    console.log("⏳ SIGNED_UP detected - waiting for logout");
                    // Khi signup, không set isLoggedIn vì SignUpScreen sẽ logout
                    setIsLoggedIn(false);
                }
                // Bỏ qua: USER_UPDATED, INITIAL_SESSION, PASSWORD_RECOVERY, ...
            }
        );
