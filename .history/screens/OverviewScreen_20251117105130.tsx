...
export default function HomeScreen() {
    ...
    const loadUserData = async () => {
        try {
            ...
            console.log(
                "👤 OverviewScreen loadUserData - Current user:",
                user?.id,
                user?.email
            );
            ...
            if (user) {
                ...
                if (today && Object.keys(today).length > 0) {
                    ...
                    // Demo data jika tidak ada
                    console.warn("⚠️ No today data, using demo");
                    setTodayData({
                        steps: 5234,
                        calories: 520,
                        heart_rate: 72,
                ...
                if (weekly && Object.keys(weekly).length > 0) {
                    ...
                    console.warn("⚠️ No weekly data, using demo");
                    setWeeklyData({
                        steps: 45600,
                        workout: 3,
                        water: 2000,
                ...
                setDaysBeforePeriod(daysBefore || 15);
            } else {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.grid}>
                    ...
                    <TouchableOpacity
                        style={[styles.hCard, { backgroundColor: "#E74C3C" }]}
                        onPress={() => navigation.navigate("HeartScreen")}
                    >
                        <View style={styles.hIconCircle}>
                            <AntDesign name="heart" size={18} color="#fff" />
                        </View>
                        <Text style={styles.hTitle}>Heart Rate</Text>
                        <Text style={styles.hValue}>
                            {todayData.heart_rate} bpm
                        </Text>
                        <Text style={styles.hSub}>updated 5m ago</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.hCard, { backgroundColor: "#F39C12" }]}
                        onPress={() => navigation.navigate("CaloriesScreen")}
                    >
                        <View style={styles.hIconCircle}>
                            <AntDesign name="fire" size={18} color="#fff" />
                        </View>
                        <Text style={styles.hTitle}>Calories</Text>
                        <Text style={styles.hValue}>
                            {todayData.calories} kcal
                        </Text>
                        <Text style={styles.hSub}>updated 15m ago</Text>
                    ...
                    <TouchableOpacity
                        style={[styles.hCard, { backgroundColor: "#9B59B6" }]}
                        onPress={() => navigation.navigate("BMIScreen")}
                    >
                        <View style={styles.hIconCircle}>
                            <AntDesign name="woman" size={18} color="#fff" />
                        </View>
                        <Text style={styles.hTitle}>BMI</Text>
                        <Text style={styles.hValue}>22.5</Text>
                        <Text style={styles.hSub}>updated a week ago</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.kpiWrap}>
                    ...
                    <View style={styles.kpiCard}>
                        <View style={styles.kpiLeft}>
                            <AntDesign name="man" size={14} color="#5865F2" />
