...
export default function HomeScreen() {
    ...
    const [todayData, setTodayData] = useState({ steps: 0, calories: 0, heart_rate: 0, sleep_hours: 0 });
    const [weeklyData, setWeeklyData] = useState({ steps: 0, workout: 0, water: 0, sleep: '0h 0min' });
