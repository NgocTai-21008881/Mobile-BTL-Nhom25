...
export default function SignInScreen() {
    ...
    const handleSignUp = async () => {
        ...
        try {
            ...
            // Nhưng nếu muốn chắc chắn, có thể insert thêm ở đây
            ...
            if (insertError) {
                console.warn("⚠️ Insert user profile warning:", insertError);
                // Không fail vì trigger đã tạo rồi
            } else {
                console.log("✅ User profile tạo thành công");
            }
