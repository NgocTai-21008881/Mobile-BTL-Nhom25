            ...
            >
                ...
                <View style={styles.grid}>
                    ...
                    >
                        ...
                        <Text style={styles.hValue}>{todayData.steps.toLocaleString()}</Text>
                    ...
                    >
                        ...
                        <Text style={styles.hValue}>
                            {Math.floor(todayData.sleep_hours)}h {Math.round((todayData.sleep_hours % 1) * 60)}min
                        </Text>
                    ...
                    >
                        ...
                        <Text style={styles.hValue}>{todayData.calories} kcal</Text>
                        <Text style={styles.hSub}>updated 15m ago</Text>
                    </View>
                </View>
