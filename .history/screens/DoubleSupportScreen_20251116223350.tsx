...
export default function DoubleSupportScreen() {
    ...
    const weekData = useMemo(() => {
        ...
        const weekStats = days.map((_, i) => {
            ...
            dayDate.setDate(dayDate.getDate() - ((new Date().getDay() - i + 7) % 7));
            ...
            <View style={styles.chartCard}>
                ...
                <View style={styles.chartContainer}>
                    <View style={styles.chartBars}>
                        {weekData.map((day, i) => {
                            const height = maxDayValue > 0 ? (day.total / maxDayValue) * 120 : 20;
                            return (
                                <View key={i} style={styles.barWrapper}>
                                    <View
                                        style={[
                                            ...
                                            {
                                                height,
                                                backgroundColor: day.total > 0 ? "#7E4DFF" : "#E0E0E0",
                                            },
                                        ]}
                                    />
                    ...
                    sessions.slice(0, 5).map((session) => (
                        <View key={session.id} style={styles.sessionCard}>
                            ...
                            <View style={styles.sessionRight}>
                                ...
                                <Text style={styles.sessionDurationLabel}>phút</Text>
                            </View>
                        </View>
                    ))
                ) : (
