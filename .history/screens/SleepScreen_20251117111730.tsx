            ...
            <View style={styles.barChartContainer}>
                {labels.map((l, i) => {
                    ...
                    const barHeight = record
                        ...
                        : 0;
                    // Làm nổi bật ngày 'Sat' như trong hình
                    const isSelectedDay = l === "Sat";
                            ...
                            <View style={styles.barBackground}>
                                <View
                                    style={[
                                        ...
                                        }, // Đảm bảo cột có chiều cao tối thiểu
...
const styles = StyleSheet.create({
    ...
    barForeground: {
        width: "100%",
        backgroundColor: "#7BE0EF", // Màu cyan nhạt
        borderRadius: 8,
    },
    barSelected: {
        backgroundColor: "#00BCD4", // Màu cyan đậm
    },
    barLabel: {
        fontSize: 12,
        color: "#999",
