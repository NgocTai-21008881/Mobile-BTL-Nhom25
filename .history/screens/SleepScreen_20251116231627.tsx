...
export default function SleepScreen() {
    ...
    useEffect(() => {
        if (!userId) {
            console.log("No userId, skipping loadData");
            return;
        }
        console.log("Loading data for userId:", userId, "selectedTab:", selectedTab);
        loadData();
    }, [userId, selectedTab]);
        ...
        >
            ...
            <View style={styles.statsCard}>
                ...
                <Text style={styles.statsValue}>
                    {Math.floor(avgSleep)}h{" "}
                    {Math.round((avgSleep % 1) * 60)}
