...
const commonFoods: FoodItem[] = [
    ...
    { id: "12", name: "Nước ngọt", calories: 140, unit: "1 chai 330ml", emoji: "🥤" },
];
...
export default function CaloriesScreen() {
    ...
    const loadCaloriesData = async () => {
        try {
            ...
            if (data.length > 0) {
                setCaloriesData(
                    data.map((d: any) => d.calories || 1800 + Math.random() * 600)
                );
                setLabels(
                    data.map((d: any) =>
    ...
    const saveCustomCalories = () => {
        ...
        const totalCals =
            (customCalories ? parseFloat(customCalories) : 0) + totalSelectedCalories;
        Alert.alert(
            "Thành công",
            `Bạn đã nhập ${totalCals} kcal`,
            [
                {
                    text: "OK",
                    onPress: () => {
    ...
    return (
        ...
        >
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerSubtitle}>Theo dõi calo tiêu hao mỗi ngày</Text>
            </View>
                            ...
                            >
                                <View
                                    style={[
                                        ...
                                        {
                                            height: barHeight,
                                            backgroundColor: isSelected ? "#5865F2" : "#A0C4FF",
                                        },
                                    ]}
                                />
                                <Text
                                ...
                                {isSelected && (
                                    <Text style={styles.barValue}>{v} kcal</Text>
                                )}
                            </TouchableOpacity>
                        );
                    })}
            ...
            <View style={styles.tipsCard}>
                <Text style={styles.tipsTitle}>💡 Lời khuyên cân bằng calo</Text>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>1</Text>
                    <Text style={styles.tipText}>Ăn 5 bữa nhỏ/ngày thay vì 3 bữa lớn</Text>
                </View>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>2</Text>
                    <Text style={styles.tipText}>Tập luyện 30 phút mỗi ngày</Text>
                </View>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>3</Text>
                    <Text style={styles.tipText}>Chọn thực phẩm lành mạnh, tự nhiên</Text>
                </View>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>4</Text>
                    <Text style={styles.tipText}>Uống nước đủ, hạn chế đồ uống có đường</Text>
                </View>
            </View>
                ...
                <View style={styles.goalProgressBox}>
                    <View style={styles.goalBar}>
                        <View
                            style={[
                                styles.goalProgress,
                                { width: Math.min(100, (avgCalories / 2000) * 100) + "%" },
                            ]}
                        />
                    </View>
                    <Text style={styles.goalText}>{avgCalories} / 2000 kcal</Text>
                </View>
                <Text style={styles.goalDesc}>
                    Mục tiêu hàng ngày là 2000 kcal - Điều chỉnh theo cơ thể của bạn
                </Text>
            </View>
