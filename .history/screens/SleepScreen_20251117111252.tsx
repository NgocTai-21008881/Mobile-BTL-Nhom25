...
const styles = StyleSheet.create({
    ...
    chartContainer: {
        alignItems: "center",
        marginTop: 5,
        marginBottom: 20, // giÃ£n dÆ°á»›i cho cÃ¢n
    },
    statsRow: {
        flexDirection: "row",
        justifyContent: "space-around",
        marginBottom: 30, // giÃ£n thÃªm khoáº£ng cÃ¡ch
    },
    statCard: {
        backgroundColor: "#fff",
        borderRadius: 14,
