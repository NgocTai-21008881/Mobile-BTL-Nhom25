            ...
            >
                ...
                <View style={styles.kpiWrap}>
                    ...
                    <View style={styles.kpiCard}>
                        ...
                        <Text style={styles.kpiValue}>{weeklyData.steps.toLocaleString()}</Text>
                    </View>
                    ...
                    <View style={styles.kpiCard}>
                        ...
                        <Text style={styles.kpiValue}>{weeklyData.workout}</Text>
                    </View>
                    ...
                    <View style={styles.kpiCard}>
                        ...
                        <Text style={styles.kpiValue}>{weeklyData.water} ml</Text>
                    </View>
