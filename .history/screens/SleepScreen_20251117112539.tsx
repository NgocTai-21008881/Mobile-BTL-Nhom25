...
const styles = StyleSheet.create({
    ...
    modalTitle: { fontSize: 20, fontWeight: "800", color: "#5865F2", textAlign: "center", flex: 1 },
    pickerRow: {
        flexDirection: "row",
        justifyContent: "center",
        alignItems: "center",
    ...
    pickerLbl: { fontSize: 13, color: "#5865F2", marginBottom: 12, fontWeight: "600" },
    ...
    confirmTxt: { fontSize: 17, fontWeight: "800", color: "#fff", letterSpacing: 0.5 },
});
