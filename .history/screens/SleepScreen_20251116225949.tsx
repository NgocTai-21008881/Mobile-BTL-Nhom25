...
const styles = StyleSheet.create({
    ...
    // Unused styles from before (keeping for backward compatibility)
    header: { marginBottom: 24 },
    headerTitle: { fontSize: 28, fontWeight: "800", color: "#1F2937", marginBottom: 8 },
    headerSubtitle: { fontSize: 14, color: "#6B7280" },
    mainCard: { backgroundColor: "#fff", borderRadius: 20, padding: 24 },
    cardTop: { marginBottom: 16 },
    cardLabel: { fontSize: 14, color: "#6B7280", fontWeight: "500", marginBottom: 8 },
    cardValue: { fontSize: 48, fontWeight: "800", color: "#1F2937" },
    cardUnit: { fontSize: 14, color: "#6B7280", marginTop: 4 },
    sleepRate: { fontSize: 16, fontWeight: "600", color: "#00BCD4" },
    chartCard: { backgroundColor: "#fff", borderRadius: 20, padding: 20 },
    chartTitle: { fontSize: 16, fontWeight: "700", color: "#1F2937", marginBottom: 16 },
    statsSection: { gap: 12, marginBottom: 20 },
    statBox: { backgroundColor: "#fff", borderRadius: 16, padding: 16, flexDirection: "row" },
    statIconBox: { width: 48, height: 48, borderRadius: 12, backgroundColor: "#FFE8E8", marginRight: 12 },
    statIconBox2: { width: 48, height: 48, borderRadius: 12, backgroundColor: "#FFF3E0", marginRight: 12 },
    statBoxLabel: { fontSize: 13, color: "#6B7280", marginBottom: 4 },
    statBoxValue: { fontSize: 18, fontWeight: "700", color: "#1F2937" },
    scheduleHeader: { marginBottom: 16 },
    scheduleTitle: { fontSize: 18, fontWeight: "700", color: "#1F2937" },
    timeButtonsContainer: { gap: 12, marginBottom: 16 },
    timeButton1: { backgroundColor: "#EC4752", borderRadius: 16, padding: 16, flexDirection: "row" },
    timeButton2: { backgroundColor: "#FF9800", borderRadius: 16, padding: 16, flexDirection: "row" },
    timeButtonIcon: { width: 48, height: 48, borderRadius: 12, backgroundColor: "rgba(255,255,255,0.2)", marginRight: 12 },
    timeButtonContent: { flex: 1 },
    timeButtonLabel: { fontSize: 12, color: "rgba(255,255,255,0.8)", fontWeight: "500" },
    timeButtonValue: { fontSize: 20, fontWeight: "700", color: "#fff", marginTop: 2 },
    scheduledSleepBox: { backgroundColor: "#00BCD4", borderRadius: 16, padding: 16, alignItems: "center" },
    scheduledLabel: { fontSize: 13, color: "rgba(255,255,255,0.8)", marginBottom: 4 },
    scheduledValue: { fontSize: 24, fontWeight: "700", color: "#fff" },
    recCard: { backgroundColor: "#E3F2FD", borderRadius: 16, padding: 16, marginBottom: 24 },
    recTitle: { fontSize: 16, fontWeight: "700", color: "#1F2937", marginBottom: 12 },
    recText: { fontSize: 13, color: "#374151", lineHeight: 20, marginBottom: 8 },
});
