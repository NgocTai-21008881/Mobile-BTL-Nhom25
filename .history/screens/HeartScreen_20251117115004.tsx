    ...
    const loadHeartData = async () => {
        try {
            ...
            if (data.length > 0) {
                setHeartData(
                    data.map(
                        (d: any) => d.heart_rate || 70 + Math.random() * 30
                    )
                );
                setLabels(
                    data.map((d: any) =>
        ...
        >
            ...
            <View style={styles.guideCard}>
                ...
                <View style={styles.guideItem}>
                    ...
                    <View style={styles.guideContent}>
                        ...
                        <Text style={styles.guideItemDesc}>
                            60 - 100 bpm (tại trạng thái nghỉ)
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.guideItem}>
                    ...
                    <View style={styles.guideContent}>
                        ...
                        <Text style={styles.guideItemDesc}>
                            Dưới 60 bpm - tập thể dục đều đặn
                        </Text>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.tipsCard}>
                <Text style={styles.tipsTitle}>
                    💡 Lời khuyên cải thiện tim mạch
                </Text>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>1</Text>
                    <Text style={styles.tipText}>
                        Tập thể dục aerobic 150 phút/tuần
                    </Text>
                </View>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>2</Text>
                    <Text style={styles.tipText}>
                        Giảm căng thẳng qua thiền định
                    </Text>
                </View>
                <View style={styles.tipItem}>
                    <Text style={styles.tipNumber}>3</Text>
                    <Text style={styles.tipText}>
                        Ăn lành mạnh, giảm muối và béo
                    </Text>
                </View>
                <View style={styles.tipItem}>
