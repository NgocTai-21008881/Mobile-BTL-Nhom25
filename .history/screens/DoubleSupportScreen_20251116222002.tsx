...
import { fetchDailyActivity, RangeKey, fetchActivityByMonthYear } from "../services/activityService";
...
export default function DoubleSupportScreen() {
    ...
    const loadData = async (range: RangeKey) => {
        try {
            ...
            let data;
            // Nếu selectedMonth/Year khác tháng/năm hiện tại, load theo tháng/năm đó
            const now = new Date();
            const currentMonth = now.getMonth() + 1;
            const currentYear = now.getFullYear();
            
            if (selectedMonth !== currentMonth || selectedYear !== currentYear) {
                data = await fetchActivityByMonthYear(userId!, selectedMonth, selectedYear);
            } else {
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.modalSubtitle}>
                            Xem dữ liệu cho tháng năm bạn muốn
                        </Text>
                        ...
                        <View style={styles.selectedDateInfo}>
                            <Text style={styles.selectedDateText}>
                                Đã chọn: {months[selectedMonth - 1]} năm {selectedYear}
                            </Text>
                        </View>
